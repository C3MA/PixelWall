...
"<div id=\"score\" style=\"width: 100%; text-align: center; font-weight: bold; font-size: 20px;\">Score: </div>"
"<div class=\"button unselectable\" style=\"width:80%; font-size: 40px;\" onmousedown=\"send('u')\">up</div><br />"
"<div class=\"button unselectable\" style=\"width: 48%; font-size: 80px;\" onmousedown=\"send('l')\">&lt;</div>"
"<div class=\"button unselectable\" style=\"width: 48%; font-size: 80px;\" onmousedown=\"send('r')\">&gt;</div><br />"
"<div class=\"button unselectable\" style=\"width:80%; font-size: 40px;\" onmousedown=\"send('d')\">down</div><br />"
"<div class=\"button unselectable\" style=\"width:80%; font-size: 20px;\" onmousedown=\"send('p')\">pause/play</div>"
"</div>"
"<script>"
"function wsData(data){"
"document.getElementById('score').innerHTML=\"Score: \"+data"
